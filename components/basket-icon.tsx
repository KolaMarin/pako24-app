...
export function BasketIcon({ 
  ...
  const content = (
    <>
      ...
      <Badge 
        className={cn(
          "absolute top-1/2 -translate-y-1/2 -left-1 h-5 w-5 p-0 flex items-center justify-center bg-gradient-to-r from-blue-600 to-purple-600 text-white text-xs rounded-full shadow-md",
  ...
  return (
    <Button
      ...
      className={cn(
          "relative",
          variant === "ghost" ? "hover:bg-blue-50" : "",
          variant === "outline" ? "border-2 hover:bg-blue-50 hover:border-blue-500" : "",
